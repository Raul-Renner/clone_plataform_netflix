...
function FeatureMovieWindow() {
  ...
  useEffect(() => {
    ...
    const loadAll = async () => {
      ...
      //pegando o featured
      let originals = list.filter(i => i.slug === 'FilmesOriginais');
  ...
  return (
    <div>
      ...
      {featureData &&
        <FeatureMovie item={featureData} tipo={'movie'} />
      }
...
export default FeatureMovieWindow;